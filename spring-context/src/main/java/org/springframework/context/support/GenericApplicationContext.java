...
public class GenericApplicationContext extends AbstractApplicationContext implements BeanDefinitionRegistry {
	 ...
	 *
	 * annotation-zyf
	 * AnnotationConfigApplicationContext在初始化之前会调用父类的构造方法，
	 * 因为继承了GenericApplicationContext，所以会在调用子类方法之前先调用父类的构造方法
	 * 这里调用父类的构造方法就是实例化一个DefaultListableBeanFactory
	 */
	 ...
	 * @see #registerBeanDefinition
	 * 这里的refreshBeanFactory方法会被AbstractApplicationContext中的 obtainFreshBeanFactory()方法中被调用
	 * 因为GernericApplicationContext是AnnotationConfigApplicationContext的父类，在构造方法会先调用父类的
	 * 所以这里回与AbstractApplicationContext是同一个BeanFactory
	 */
	@Override
	 ...
	 *
	 * 此处的getBeanFactory，会被AbstractApplicationContext中的obtainFreshBeanFactory()方法调用
	 * 返回当前创建的BeanFactory对象
	 */
	@Override
